...
public class SearchPageObject  extends MainPageObject{
    ...
    public void typeSearchLine(String search_line){
        this.waitForElementAndSendKeys(By.xpath(SEARCH_INPUT), search_line, "Cannot find and type search input", 10);
    }

    public void waitForSearchResult(String substring){
        String search_result_xpath = getResultSearchElement(substring);
        this.waitForElementPresent(By.xpath(search_result_xpath), "Cannot find search result" + substring, 10);
    }
    ...
    public void assertThereIsNoResultPage(){
        assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "We supposted not find any results");
    }

    public void assertThereIsSomethingOnTheResultPage(){
        assertElementPresent(By.xpath(SEARCH_RESULT_ELEMENT), "Hmm, but we shouldn't see some articles");
    }

    public void checkTextIsDisplayedInSearchField(){

        this.waitForElementPresent(By.xpath(SEARCH_TEXT), "Cannot find text in search input", 15);
    }
    ...
    public String getTextFromSearchField(){
        WebElement secondElement = this.waitForElementPresent(
                By.id("org.wikipedia:id/search_src_text"),
                "Search input is not appeared",
                15);
